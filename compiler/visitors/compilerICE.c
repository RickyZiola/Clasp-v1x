...
void visitor_literal_int(int val) {
    ...
    // VirtualICE assembly for loading a constant onto the stack:
    //               ; Initial,        stack = [ ]
    // const.i <n>   ; Constnant load, stack = [n]

    // TODO: implement VirtualICE bytecode once the instruction set is final
}
void visitor_op_unary(TokenTyp operator_type) {
    switch (operator_type) {
        case TOKEN_MINUS: {
            ...
            // VirtualICE assembly for negating a value on the stack:
            //             ; Initial,         stack = [n  ]
        ...
        case TOKEN_BANG: {
            ...
            // VirtualICE assembly for a bitwise NOT:
            //              ; Initial,     stack = [n ]
...
void visitor_op_binary(TokenTyp operator_type) {
    ...
    switch (operator_type) {
        case TOKEN_PLUS: {
            ...
            // VirtualICE assembly for adding 2 numbers:
            //          ; Initial,  stack = [n m]
        ...
        case TOKEN_MINUS: {
            ...
            // VirtualICE assembly for subtracting 2 numbers:
            //          ; Initial,     stack = [n m]
        ...
        case TOKEN_ASTERIX: {
            ...
            // VirtualICE assembly for multiplying 2 numbers:
            //          ; Initial,        stack = [n m]
        ...
        case TOKEN_SLASH: {
            ...
            // VirtualICE assembly for dividing 2 numbers:
            //          ; Initial,  stack = [n m]
